      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="px-1 sm:px-3 md:px-4">
            <div className="">
              <h3 className="text-base font-semibold text-gray-600 dark:text-primary-400 flex items-center">
            ...
            <div className="py-4">
              ...
              <CoverageUtilization loading={isLoadingCoverage} />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="bg-gray-20 p-4 border-b border-gray-200 dark:border-gray-700">
