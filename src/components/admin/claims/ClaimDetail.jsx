...
import { FiChevronLeft, FiCheck, FiX, FiLoader } from "react-icons/fi";
import {
  TbFileInvoice,
  TbClock,
  TbUser,
...
const ClaimDetail = ({ claim, onDelete, onStatusUpdate }) => {
  ...
  const handleStatusUpdate = async () => {
    ...
    if (
      ...
      statusUpdateData.amountApproved <= 0
    ) {
      ...
      <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
        <div>
          <h3 className="text-lg font-semibold text-amber-700 dark:text-white flex items-center">
            <TbFileInvoice className="mr-2 h-6 w-6 text-amber-700" />
        ...
        <div className="flex space-x-3">
          <Link
            ...
            className="inline-flex items-center px-6 py-1.5 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-admin-500"
          >
            <TbEdit className="mr-1.5 h-5 w-5" />
            Edit
          </Link>
          <button
            onClick={() => onDelete(claim.id)}
            className="inline-flex items-center px-6 py-1.5 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium rounded-md text-red-700 dark:text-red-300 hover:bg-red-100 dark:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
          >
            <TbTrash className="mr-1.5 h-5 w-5" />
            Delete
          </button>
        </div>
      </div>
      ...
      <div className="px-6 py-5">
        ...
        <div className="flex flex-wrap justify-between items-center mb-4">
          <div className="flex items-center mb-2 sm:mb-0">
            ...
            <span className="text-sm font-semibold text-gray-600 dark:text-white capitalize">
              {claim.type} Claim
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-100 dark:bg-gray-700/30 p-4 rounded-lg">
            <h4 className="text-sm font-semibold text-admin-700 dark:text-admin-400 flex items-center mb-3">
              <PiUserDuotone className="mr-1.5 h-5 w-5" />
              Member Information
            </h4>
          ...
          <div className="bg-gray-100 dark:bg-gray-700/30 p-4 rounded-lg">
            ...
            <div className="text-sm text-gray-900 dark:text-white">
              <p className="font-medium">
                {claim.providerName} - {claim.providerLocation}
              </p>
            </div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-4">
          <div className="bg-gray-100 dark:bg-gray-700/30 p-5 rounded-lg">
            <h4 className="text-sm font-semibold text-admin-700 dark:text-admin-400 flex items-center mb-3">
        ...
        {claim.status !== "approved" && (
          <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-6">
            <h4 className="text-base font-semibold text-admin-700 dark:text-admin-400 mb-4 flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  className="mt-1 block w-full pl-3 pr-10 py-2.5 text-base border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-admin-500 focus:border-admin-500 sm:text-sm rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                >
              ...
              >
                ...
                <textarea
                  ...
                  className="mt-1 block w-full border p-4 border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-admin-500 focus:border-admin-500 sm:text-sm dark:bg-gray-700 dark:text-white"
