...
import { PiMapPinAreaBold, PiMapPinAreaDuotone, PiUserDuotone } from "react-icons/pi";
import { RiUserCommunityFill } from "react-icons/ri";
import { TbIdBadge, TbIdBadge2, TbMailFilled, TbPhone, TbUserEdit } from "react-icons/tb";
        ...
        <div className="grid grid-cols-1 gap-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="relative">
                <PiMapPinAreaBold className="w-5 h-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                <input
                  type="text"
                  id="county"
                  name="county"
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <div className="relative">
                <RiUserCommunityFill className="w-5 h-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                <input
                  type="text"
                  id="sacco"
                  name="sacco"
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <div className="relative">
                <TbIdBadge2 className="w-5 h-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                <input
                  type="text"
                  id="idNumber"
                  name="idNumber"
                  ...
                  disabled={true}
                  className="w-full text-sm sm:text-base pl-10 pr-4 py-2 border border-transparent bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-white rounded-lg cursor-not-allowed"
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <TbIdBadge className="w-5 h-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                <input
                  type="text"
                  id="membershipNumber"
