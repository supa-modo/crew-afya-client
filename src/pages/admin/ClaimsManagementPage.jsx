...
import { FiPlus, FiFilter, FiSearch, FiChevronDown, FiChevronUp, FiChevronLeft, FiChevronRight, FiEdit, FiEye, FiTrash2 } from 'react-icons/fi';
import { TbFileInvoice, TbFilter, TbSearch } from 'react-icons/tb';
...
const ClaimsManagementPage = () => {
  ...
  const getSortedClaims = () => {
    ...
    let filteredData = claims.filter(claim => {
      const matchesSearch = 
        claim.user?.firstName?.toLowerCase().includes(searchTerm.toLowerCase()) ||
        claim.user?.lastName?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    if (sortConfig.key) {
      filteredData.sort((a, b) => {
        ...
        // Handle dates
        if (sortConfig.key === 'submissionDate' || sortConfig.key === 'serviceDate' || sortConfig.key === 'processedDate') {
        ...
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            ...
            <p className="mt-2 text-sm text-gray-700 dark:text-gray-300">
              View, approve, and manage all medical claims submitted by members.
            </p>
          </div>
